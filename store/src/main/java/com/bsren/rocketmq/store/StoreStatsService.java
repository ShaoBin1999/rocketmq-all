...
public class StoreStatsService extends ServiceThread {
    ...
    public String toString() {
        ...
        sb.append("\tputMessageDistributeTime: " + this.getPutMessageDistributeTimeStringInfo(totalTimes)
            + "\r\n");
        sb.append("\tputMessageAverageSize: " + (this.getPutMessageSizeTotal() / (double) totalTimes)
            + "\r\n");
        ...
        sb.append("\tgetTransferedTps: " + this.getGetTransferredTps() + "\r\n");
        return sb.toString();
    }
    ...
    private String getGetTransferredTps() {
        ...
        return this.getGetTransferredTps(10) +
                " " +
                this.getGetTransferredTps(60) +
                " " +
                this.getGetTransferredTps(600);
    }
    ...
    public HashMap<String, String> getRuntimeInfo() {
        ...
        result.put("getTransferedTps", String.valueOf(this.getGetTransferredTps()));
