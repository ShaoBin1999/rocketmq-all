...
import com.bsren.rocketmq.common.running.RunningStats;
...
import com.bsren.rocketmq.store.index.IndexService;
import com.bsren.rocketmq.store.index.QueryOffsetResult;
...
import static com.bsren.rocketmq.store.config.BrokerRole.SLAVE;
...
public class DefaultMessageStore implements MessageStore {
    ...
    /**
     * 定期删除commitLog，或者根据磁盘利用率来删除，或者手动删除
     */
    class CleanCommitLogService {
        ...
        private void deleteExpiredFiles() {
            ...
            boolean isSpaceFull = this.isSpaceToDelete();
            boolean manualDelete = this.manualDeleteFileSeveralTimes > 0;

            if (isTimeUp || isSpaceFull || manualDelete) {
