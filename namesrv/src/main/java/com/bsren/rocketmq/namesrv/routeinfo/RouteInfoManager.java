 ...
 */
package com.bsren.rocketmq.namesrv.routeinfo;
...
public class RouteInfoManager {
    ...
    //broker到brokerData的映射
    private final HashMap<String/* brokerName */, BrokerData> brokerAddrTable;
    //集群到broker集合的映射
    private final HashMap<String/* clusterName */, Set<String/* brokerName */>> clusterAddrTable;
    //broker到brokerLiveInfo的映射
    private final HashMap<String/* brokerAddr */, BrokerLiveInfo> brokerLiveTable;
    //broker到filterServer列表的映射
     ...
     * @param brokerId    brokerId, 0表示master，如果是slave，则会将master的信息填充到broker的HaServerAddr和MasterAddr
     * @param haServerAddr ha address
     * @param topicConfigWrapper topic
     * @param filterServerList filterServer列表，如果传空则将直接的全部删除，否则进行添加
    ...
    public RegisterBrokerResult registerBroker(
        ...
        try {
            try {
                ...
                //如果是主节点,新注册或者topic信息版本(QueueData)发生变化,则在nameServer上进行更新
    ...
    /**
     * 删除brokerName下的所有queueData，如果该topic对应下的queueData被删除完了，则清除topic
     */
