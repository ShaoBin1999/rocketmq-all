 ...
 */
package com.bsren.rocketmq.broker.slave;
...
import com.bsren.rocketmq.common.protocol.body.ConsumerOffsetSerializeWrapper;
import com.bsren.rocketmq.common.protocol.body.SubscriptionGroupWrapper;
...
public class SlaveSynchronize {
    ...
    /**
     *  向master请求topicConfig数据
     *  如果版本不一致，则取master的版本，然后将configTable里的config删掉再新增，最后落到文件里
     */
