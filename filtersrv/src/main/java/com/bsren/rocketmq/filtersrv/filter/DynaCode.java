...
public class DynaCode {
    ...
    public static Class<?> compileAndLoadClass(final String className, final String javaSource)
        ...
        String newJavaCode = javaSource.replaceAll(classSimpleName, newClassSimpleName);
        ...
        return map.get(getQualifiedName(newJavaCode));
    }
    ...
    public static String getPackageName(String code) {
        return StringUtils.substringBefore(StringUtils.substringAfter(code, "package "), ";").trim();
    }
