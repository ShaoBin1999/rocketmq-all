...
package com.bsren.rocketmq.filtersrv.processor;
...
import com.bsren.rocketmq.common.protocol.header.filtersrv.RegisterMessageFilterClassRequestHeader;
import com.bsren.rocketmq.common.sysflag.MessageSysFlag;
import com.bsren.rocketmq.filtersrv.FiltersrvController;
import com.bsren.rocketmq.filtersrv.filter.FilterClassInfo;
...
import com.bsren.rocketmq.store.CommitLog;
...
/**
 * 一共两种请求
 * RequestCode.REGISTER_MESSAGE_FILTER_CLASS 注册过滤类
 * RequestCode.PULL_MESSAGE 拉取消息，如果拉取被过滤掉则重新拉取
 */
                    ...
                    case FOUND:
                        ...
                        try {
                            ...
                            if (!msgListOK.isEmpty()) {
                                ...
                                response.setCode(ResponseCode.PULL_RETRY_IMMEDIATELY);   //todo 进行重试
                            }
                        } catch (Throwable e) {
                            final String error =
